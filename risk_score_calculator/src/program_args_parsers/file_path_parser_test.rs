...
mod file_path_parser_test {
    ...
    fn get_alleles_from_args_file_exist() {
        ...
        assert_eq!(result.non_hla_alleles[0].locus, "rs540653847");
        assert_eq!(result.non_hla_alleles[0].variants[0], "A");
        assert_eq!(result.non_hla_alleles[0].variants[1], "GC");
        assert_eq!(result.other_hla_alleles[0].locus, "rs3842753");
        assert_eq!(result.other_hla_alleles[0].variants[0], "G");
        assert_eq!(result.other_hla_alleles[0].variants[1], "G");
    }
}